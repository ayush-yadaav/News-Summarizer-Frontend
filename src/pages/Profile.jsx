...
export default function ProfilePage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0b1224] text-center text-white flex items-center justify-center">
        <p>Loading profile...</p>
      </div>
    );
  }
  ...
  return (
    <div className="relative min-h-screen bg-[#0b1224] text-white px-8 py-10 ml-0 md:ml-64 transition-all duration-300">
      ...
      <div className="max-w-lg mx-auto bg-[#121b36] rounded-2xl shadow-xl p-8 border border-blue-900/30">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-[#0b1224] border border-gray-700 rounded-lg text-white focus:outline-none focus:border-blue-500"
            />
          </div>
